...
* [👋 Welcome](README.md)
* [📌 FAQ](faq.md)
* [⭐ Premium System](premium-system.md)

## 🛠 Getting Started

* [➕ Invite the Bot](https://rookie-spitfire.cf/invite)
* [❓ Join Support Server](https://rookie-spitfire.cf/support)
* [📥 Login](getting-started/login.md)

## ✨ Popular Features <a href="#features" id="features"></a>
